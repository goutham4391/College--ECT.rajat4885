...
(function ($, Drupal) {
    ...
    attach: function (context, settings) {
      ...
      $(window)
        ...
        .on("load", function () {
          ...
          const globalNavMenu = $(".global-navigation-menu");
          const globalNavItem = document.querySelectorAll(
            ".global-navigation-menu .global-navigation-menu__item--first-level"
          );
          const globalNavList = $(".global-navigation-menu__list");
          //const globalNavSubMenu = $($.parseHTML('<nav id="globalNavSubMenu"></nav>'));
          const globalNavSubMenu = document.createElement("nav");
          const siteMenu = $(
          ...
          // const globalNavSubMenu = document.querySelector('#globalNavSubMenu');
  ...
  Drupal.behaviors.calculateColor = {
    attach: function (context, settings) {
      $(".global-navigation-menu__item--first-level").each(function() {
        ...
        var myColor = $(this).css('--rw-primary-color');
        ...
        if(o > 125) {
          $(this).find('.global-navigation-menu__label').css('--rw-text-color', '#000000');
        }else{
          $(this).find('.global-navigation-menu__label').css('--rw-text-color', '#ffffff');
        }
