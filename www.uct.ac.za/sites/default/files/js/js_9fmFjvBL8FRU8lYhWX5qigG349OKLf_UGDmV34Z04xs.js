...
jQuery(document).ready(function ($) {
  ...
  /* 
    Add Event Calendar link to Upcoming event feed
  */
  var linkHTML = '<div class="text-right"><a class="button button--cta-readmore button--cta-readmore--slide" href="/events-calendar">Events Calendar</a></div>'
  $(linkHTML).appendTo('.paragraph--type--upcoming-events');
